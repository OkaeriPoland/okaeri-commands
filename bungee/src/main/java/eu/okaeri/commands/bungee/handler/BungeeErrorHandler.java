...
public class BungeeErrorHandler implements ErrorHandler {

    private final Commands commands;
    private final HelpBuilder helpBuilder;

    public BungeeErrorHandler(@NonNull Commands commands) {
        this.commands = commands;
        this.helpBuilder = new HelpBuilder() {
            @Override
            public String getTemplateForHelp(CommandData data, Invocation invocation) {
                return BungeeErrorHandler.this.resolveText(data, invocation,
    ...
    public Object handle(@NonNull CommandData data, @NonNull Invocation invocation, @NonNull Throwable throwable) {
        ...
        ProxyServer.getInstance().getLogger().log(Level.SEVERE, "Unexpected exception in the command system [id=" + exceptionID + "]", throwable);
