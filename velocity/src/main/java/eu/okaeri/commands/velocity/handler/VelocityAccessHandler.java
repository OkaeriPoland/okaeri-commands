...
public class VelocityAccessHandler implements AccessHandler {
    ...
    public boolean allowAccess(@NonNull ServiceMeta service, @NonNull Invocation invocation, @NonNull CommandData data, boolean checkExecutors) {
        ...
        if (!data.has("sender", CommandSource.class)) {
    ...
    protected boolean hasPermissions(@NonNull CommandSource sender, @NonNull Set<String> permissions, @NonNull Permission.Mode mode) {
